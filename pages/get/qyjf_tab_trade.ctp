      ...
      <div class="block" style="margin: 12px 0;">
        ...
        <div class="text-align-left">
          ...
          <ol>
            ...
            <li>首个交易日不可为节假日</li>
            <li>首个交易日开盘期权对应股票出现涨跌幅超过9%或停牌情况，交易取消并退还全部期权金</li>
...
return {
  methods: {
        ...
        <tr>
          <td class="text-align-center" >
            <label class="item-radio1 item-content1 radio">
              <input type="radio" name="stockIdRadio" value="${detail.id}" ${i==0?"checked":""} />
              <i class="icon icon-radio" style="left:0" data-id="${detail.id}" data-price="${detail.price}" data-code="${detail.code}" data-step="${detail.step}"></i>
            </label>
          </td>
    ...
    <div class="card data-table">
      ...
      `;
      let t = $(template);
      t.find('.icon-radio').click(self.showoptiondetail2);
      return t;
    },
    showCalc: function() {
      let self = this;
